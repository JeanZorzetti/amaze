          ...
          <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="size-20 rounded-xl bg-orange/20 group-hover:bg-orange/30 flex items-center justify-center transition-colors">
                <svg className="size-10 text-orange" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <div className="w-full bg-orange group-hover:bg-orange/90 rounded-full py-3 flex items-center justify-center gap-2 transition-colors">
                ...
                <span className="text-white text-xs font-black uppercase tracking-widest">Baixar Manual PDF</span>
              </div>
            </a>
          </div>
        </section>
