            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {components.map((comp) => (
                <div key={comp.num} className="relative bg-surface-container-low border border-border rounded-xl overflow-hidden">
                  <div className="w-full aspect-square bg-surface-container-low border-b-2 border-dashed border-border flex flex-col items-center justify-center gap-3 text-muted">
                    <svg className="size-10 opacity-30" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
                    </svg>
                    <span className="text-xs font-bold uppercase tracking-widest opacity-50">Foto do produto</span>
